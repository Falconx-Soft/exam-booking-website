...
const national_inspection_testing_and_certification_corporation_section1 = '<div class="section1"><input type="checkbox" value="select_all-1" id="select_option_checkbox" onclick="select_checkbox(this)"><label for="">Select Examset</label><div class="chunk"><div class="chunk-div"><input type="checkbox" id="select_option_checkbox" onclick="select_checkbox(this)" name="NBOPE-closed" value="NBOPE Journeyman Plumber 2018 (Closed)--1"><div class="chunk-div1"><label for="NBOPE-closed"><b>NBOPE Journeyman Plumber 2018 (Closed) </b></label><br><div class="testing-window"><label for="NBOPE-testing-window" >Testing Window: 20 OCT 2021 to 31 DEC <br> 9999 </label></div></div></div><div class="chunk-div2"><input type="checkbox" id="select_option_checkbox" onclick="select_checkbox(this)" name="NBOPE-open" value="NBOPE Journeyman Plumber 2018 (Open)--1"><div class="chunk-div2-2"><label for="NBOPE-open"><b>NBOPE Journeyman Plumber 2018 (Open)</b></label><br><div class="testing-window"><label for="NBOPE-testing-window" >Testing Window: 20 OCT 2021 to 31 DEC <br> 9999</label></div></div></div><div class="chunk-bottom-border"></div></div></div>'

const national_inspection_testing_and_certification_corporation_section2 = '<div class="section2"><input type="checkbox" value="select_all-2" id="select_option_checkbox" onclick="select_checkbox(this)"><label for="">Select Examset</label><div class="chunk"><div class="chunk-div"><input type="checkbox" id="select_option_checkbox" onclick="select_checkbox(this)" name="plumber-closed" value="NBOPE Master Plumber 2018 (Closed)--2"><div class="chunk-div1"><label for="plumber-closed"><b>NBOPE Master Plumber 2018 (Closed)</b></label><br><div class="testing-window"><label for="testing-window" >Testing Window: 20 OCT 2021 to 31 DEC <br> 9999  </label></div></div></div><div class="chunk-div2"><input type="checkbox" id="select_option_checkbox" onclick="select_checkbox(this)" name="plumber-open"><div class="chunk-div2-2" value="NBOPE Master Plumber 2018 (Open)--2"><label for="plumber-open"><b>NBOPE Master Plumber 2018 (Open)</b></label><br><div class="testing-window"><label for="testing-window" >Testing Window: 20 OCT 2021 to 31 DEC <br> 9999 </label></div></div></div><div class="chunk-bottom-border"></div></div></div>'

const national_inspection_testing_and_certification_corporation_section3 = '<div class="section3"><div class="chunk"><div class="chunk-div"><input onclick="select_radiobtn(this)" type="radio" name="radio" id="select_option_radio" value="Journey Level Air Conditioning and Refrigeration"><div class="chunk-div1"><label for="journey-level"><b>Journey Level Air Conditioning and Refrigeration   </b></label><br><div class="testing-window"><label for="testing-window" >Testing Window: 11 OCT 2021 to 31 DEC <br> 9999  </label></div></div></div><div class="chunk-div2"><input onclick="select_radiobtn(this)"type="radio" id="select_option_radio" name="radio" value="Journey Level Plumber 2018"><div class="chunk-div2-2"><label for="plumber-2018"><b>Journey Level Plumber 2018</b></label><br><div class="testing-window"><label for="testing-window" >Testing Window: 11 OCT 2021 to 31 DEC <br> 9999</label></div></div></div><div class="chunk-div2"><input onclick="select_radiobtn(this)" type="radio" name="radio" id="select_option_radio" value="Journey Level Plumber 2021 "><div class="chunk-div2-2"><label for="plumber-2021"><b>Journey Level Plumber 2021 </b></label><br><div class="testing-window"><label for="testing-window" >Testing Window: 15 APR 2022 to 31 DEC <br> 9999</label></div></div></div><div class="chunk-bottom-border"></div></div></div>'
...
test_program.addEventListener("change", function (event) {
    ...
    // }
        ...
        test_test.appendChild(set_options("Surveillance à distance : examen simulé (pharmaciens)"));
        test_test.appendChild(set_options("Surveillance à distance : examen simulé (tech pharm)"));
    }
    else if (event.target.value == "Pharmacy Examining Board of Canada") {
        ...
        test_test.appendChild(set_options("Examen d'évaluation (pharmaciens)"));
